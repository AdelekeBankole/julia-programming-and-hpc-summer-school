...
md"# Introduction to Julia Programming"
...
z ≈ -1 ? print("Hurray!") : print("No")  # ternary operator

# ╔═╡ 29480b67-e223-46c9-bcc4-5a56af26bb55
z ≈ exp(im * π)
...
# ╔═╡ b0da6ad1-7902-40c2-916d-9a0798db41fa
md" Let us compute some machine epsilon, there exists a largest number, which we call ϵ for all x, 1 + x = 1 such that abs(x)< ϵ"
...
# ╔═╡ cfd11bd8-eb38-4ff9-94e5-32b7c2c5e815
md"Julia is built around types, high performance codes will make use of the type system. Type signatures (declarations) in the form `binder :: type`."
...
md"Values of abstract types cannot be constructed directly, `example: Number` with this, we can do operations like `+`, `-`, `*`, and `/` with corresponding values."

# ╔═╡ d10c97a6-64c7-4adf-bf76-c25e19f7f215
# Function with parameter and return types explicitly
...
# ╔═╡ f9d4321d-4ad6-44ad-89ea-b82d82c45f37
typeof(Tz)
...
# ╔═╡ cc9f46bb-a0ae-4dc6-88db-e12d2b96b48f
md"## Dispatch and Multiple Dispatch"

# ╔═╡ 84790529-cabd-48c1-8f25-a9a9557e9317
...
# ╔═╡ f1dd2b06-1fa2-4a02-9e9a-7e56b828ac2d
ourabs(z::ComplexF64) = sqrt(real(z * conj(z)))

# ╔═╡ 162beff7-2e9d-4358-b61d-090db8eaf642
ourabs(a::Real) = sign(a) * a

# ╔═╡ 813d16e6-4346-4df3-a133-d25078f24352
ourabs(z::Complex) = sqrt(real(z * conj(z)))

# ╔═╡ d44e4157-6a3e-4824-ac13-2e0faed030aa
ourabs(-5.32)

# ╔═╡ d0ea5425-3613-4d95-aaf6-31aba8c03ebd
methods(ourabs)

# ╔═╡ b89b891a-dc4c-41fd-953f-b83294bbaf59
ourabs(-4)

# ╔═╡ 830fb25a-ef21-4886-a573-6c0e7d3592fa
...
# ╔═╡ 2672638a-00df-40b5-bfa9-48d508642707
begin
...
# ╔═╡ 06e28053-20ac-467c-afb0-ff494a9c1d9c
methods(g)

# ╔═╡ 75fe5f4e-f530-4439-9a4f-57fd616a17f7
g(2.5, 5)

# ╔═╡ 856571c1-1f79-41cd-bb1d-0d9c814b0db0
g(2.5, 5.5)

# ╔═╡ 3ed9a2ef-fbec-43be-b5a6-100aa0972100
g(5, "DSA2026")

# ╔═╡ aeb1fd1e-4bf6-4652-8820-443595afc3df
md"We can check which particular method used via the `@which` macro"

# ╔═╡ e18eff67-6d32-45c9-894f-3197aef51b99
@which g(2.5, 5.5)
...
md"A tuple is a fixed-length container which can hold any values, but cannot be modified, i.e. immutable, tuples are constructed with commas and parenthesis, they can be accessed via indexing."
...
# ╔═╡ 5de68ff5-14f1-4458-b3a0-86b97fe8ae3d
begin
	eps = 1
	while 1 + eps != 1
		eps = eps / 2
...
# ╔═╡ 635f0a28-dcef-454f-862f-44242b68c68c
ourabs(4.0 + 5.0im)
...
plot(f, legend=:bottomright, linewidth = 3.0)

# ╔═╡ 13f4802a-16d4-4515-ba5e-ce4a28f7e0bb
md"## Conclusion"

# ╔═╡ b00a8226-e5f3-4726-b55f-fe39fb60e876
md"We can put all these ideas together to use in models that can be found in this working directory."

# ╔═╡ 8507eceb-2f1b-4754-8a2b-c595dedb03ec
md"## Appendix"

# ╔═╡ 7a2c07a9-b173-49b9-b5c7-dffd542366f4
md" Dictionary"

# ╔═╡ 4c34008f-831d-43c7-a218-e16482cb9c3f
...
# ╔═╡ 9f38e733-69ea-44c4-9fa8-0e52e03e934c
md" Type Hierarchy"
...
manifest_format = "2.0"
project_hash = "58fda31812999130e148e05b6d63ff2f5c1acba2"
